...
// const VerificationTypeSelector = ({ formData, setFormData, onNext }) => {
...
//       steps: getStepsForType(finalSelected[0]) 
//     }));
//     onNext();
//   };
...
//             <div>
//               <h2 className="text-xl font-semibold text-gray-900">Verification Types</h2>
//               <p className="text-gray-600 mt-1">Choose one or more verification types to proceed</p>
//             </div>
