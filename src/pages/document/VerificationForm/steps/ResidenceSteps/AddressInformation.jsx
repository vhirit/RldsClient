...
const AddressInformation = ({ formData, setFormData, onSectionSave }) => {
    ...
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border border-green-100">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div>
          ...
          <textarea
            rows={3}
            value={residence.presentAddress || ''}
        ...
        <div>
          ...
          <textarea
            rows={3}
            value={residence.permanentAddress || ''}
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mt-6">
        ...
        <div>
          ...
          <select
            value={residence.withinMunicipalLimit || ''}
